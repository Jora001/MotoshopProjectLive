...
<div className="w-full max-w-6xl mt-12 px-6 flex flex-col md:flex-row gap-30 ml-[165px]">
...
<p className="whitespace-pre-line text-gray-300 text-[20px] leading-[26px]">
      {[
        {
          id: "mission",
          description:

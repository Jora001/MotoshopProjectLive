...
const Page = () => {
  ...
  return (
    <main className="w-full min-h-screen bg-black text-white">
      ...
      {/* SORT + TOTAL ITEMS (RIGHT SIDE BELOW FILTERS) */}
      <section className="max-w-360 mx-auto px-6 lg:px-8 py-4 flex justify-end items-center gap-6">
        ...
        <div className="relative">
          ...
          >
            {activeSort}
            <span
              className={`transform transition-transform ${sortOpen ? "rotate-180" : "rotate-0"}`}
            >
              ▼
            </span>
          </button>
                ...
                <div className="p-4 flex flex-col gap-3">
                  ...
                  <div className="flex justify-between items-center">
                    <button
                      ...
                      className="px-4 py-2 border border-[#FFB300] text-[#FFB300] rounded-lg hover:bg-[#FFB300] hover:text-black transition"
                    >
                      Տեսնել ավել
                    </button>
                    <button
                      ...
                      className={`w-8 h-8 rounded-full flex items-center justify-center transition ${liked ? "bg-[#D0021B]" : "bg-white"}`}
                    >
                      <Image
                        src="/lov.jpg"
                        alt="fav"
